...
option = st.sidebar.selectbox("Watchlist?", ('Daily_review', 'INDEX', 'CURRENT', 'ETF'))
...
if option == "Daily_review":
    symbols=['SPY', 'QQQ', 'IWM', 'DIA', 'VTI', 'IWO', 'MDY', 'RSP', 'QQQE', 'SDS', 'XLK', 'SMH', 'IGV', 'TAN', 'IYW', 'QTEC', 'FFTY', 'VGT', 'CIBR', 'SKYY', 'AIQ', 'AAPL', 'AMZN', 'MSFT', 'GOOGL', 'META', 'NFLX', 'NVDA', 'TSLA', 'AMD', 'COST', 'ADBE', 'NOW', 'AVGO', 'ASML', 'LRCX', 'KLAC', 'AMAT', 'TSM', 'PANW', 'CRWD', 'ZS', 'DDOG', 'XLF', 'XLE', 'XLP', 'XLV', 'XLI', 'XLK', 'XLU', 'XLY', 'XLB', 'XOP', 'XHB', 'XME', 'OIH', 'XLC', 'ITB', 'PAVE', 'JETS', 'XBI', 'ARKK', 'ARKW']
